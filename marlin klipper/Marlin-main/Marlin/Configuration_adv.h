...
// Enable or disable the option to disable endstops
#define ENABLE_DISABLE_ENDSTOPS_OPTION
...
#define STRING_SPLASH_LINE1 "Developer Mode"
#define STRING_SPLASH_LINE2 "Enabled"
 ...
 */ 
// Custom Info Function Declaration
void customInfoMenu();

// Custom Menu: Main Menu
#define CUSTOM_MENU_MAIN
#if ENABLED(CUSTOM_MENU_MAIN)
  #define CUSTOM_MENU_MAIN_TITLE "Developer mode"
  ...
  #define MAIN_MENU_ITEM_5_CONFIRM
    ...
    #define MAIN_MENU_ITEM_6_DESC "Disable Endstops"
    #define MAIN_MENU_ITEM_6_GCODE "M211 S0"
    #define MAIN_MENU_ITEM_6_CONFIRM

    #define MAIN_MENU_ITEM_7_DESC "Self test"
    #define MAIN_MENU_ITEM_7_GCODE "G28 ; Home all axes\nG1 X10 Y10 Z10 F9000 ; Move to starting position\nM104 S200 ; Set extruder temperature to 200°C"
    #define MAIN_MENU_ITEM_7_CONFIRM 

#define MAIN_MENU_ITEM_8_DESC "Enable Advanced Error Handling"
  #define MAIN_MENU_ITEM_8_GCODE "M555 P2"
  #define MAIN_MENU_ITEM_8_CONFIRM

  #define MAIN_MENU_ITEM_9_DESC "Enable Connection to Sonic Pad"
  #define MAIN_MENU_ITEM_9_GCODE "M601"
  #define MAIN_MENU_ITEM_9_CONFIRM

  #define MAIN_MENU_ITEM_10_DESC "Disable Connection to Sonic Pad"
  #define MAIN_MENU_ITEM_10_GCODE "M602"
  #define MAIN_MENU_ITEM_10_CONFIRM

 #define MAIN_MENU_ITEM_11_DESC "Safe Mode"
  #define MAIN_MENU_ITEM_11_GCODE "M21 ; Disable all extruders\nM104 S0 ; Turn off hotend\nM140 S0 ; Turn off bed\nM84 ; Disable motors"
  #define MAIN_MENU_ITEM_11_CONFIRM

  #define MAIN_MENU_ITEM_12_DESC "Test Motors & Endstops"
  #define MAIN_MENU_ITEM_12_GCODE "M119 ; Check endstop status\nG0 X10 Y10 Z10 ; Move all axes to test movement"
  #define MAIN_MENU_ITEM_12_CONFIRM

#define MAIN_MENU_ITEM_13_DESC "Show Motor Currents"
  #define MAIN_MENU_ITEM_13_GCODE "M906 ; Display motor currents"
  #define MAIN_MENU_ITEM_13_CONFIRM

  #define MAIN_MENU_ITEM_14_DESC "Show Temperature Readings"
  #define MAIN_MENU_ITEM_14_GCODE "M105 ; Display temperature"
  #define MAIN_MENU_ITEM_14_CONFIRM

  #define MAIN_MENU_ITEM_15_DESC "Show Endstop Status"
  #define MAIN_MENU_ITEM_15_GCODE "M119 ; Check endstop status"
  #define MAIN_MENU_ITEM_15_CONFIRM

  #define MAIN_MENU_ITEM_16_DESC "Show G-Code Commands"
  #define MAIN_MENU_ITEM_16_GCODE "M111 S32 ; Display G-code commands"
  #define MAIN_MENU_ITEM_16_CONFIRM

  #define MAIN_MENU_ITEM_17_DESC "Show Axis Position"
  #define MAIN_MENU_ITEM_17_GCODE "M114 ; Display current position"
  #define MAIN_MENU_ITEM_17_CONFIRM

  #define MAIN_MENU_ITEM_18_DESC "Toggle Motors Individually"
  #define MAIN_MENU_ITEM_18_GCODE "M18 ; Turn off motors\nG0 X10 ; Move X\nG0 Y10 ; Move Y\nG0 Z10 ; Move Z"
  #define MAIN_MENU_ITEM_18_CONFIRM

  #define MAIN_MENU_ITEM_19_DESC "Toggle Heaters Individually"
  #define MAIN_MENU_ITEM_19_GCODE "M104 S0 ; Turn off hotend\nM140 S0 ; Turn off bed"
  #define MAIN_MENU_ITEM_19_CONFIRM

  #define MAIN_MENU_ITEM_20_DESC "Echo Commands"
  #define MAIN_MENU_ITEM_20_GCODE "M111 S16 ; Echo commands"
  #define MAIN_MENU_ITEM_20_CONFIRM

  #define MAIN_MENU_ITEM_21_DESC "Simulation Mode"
  #define MAIN_MENU_ITEM_21_GCODE "M111 S17 ; Enter simulation mode"
  #define MAIN_MENU_ITEM_21_CONFIRM

  #define MAIN_MENU_ITEM_22_DESC "Show Stepper Driver Status"
  #define MAIN_MENU_ITEM_22_GCODE "M122 ; Display stepper driver status"
  #define MAIN_MENU_ITEM_22_CONFIRM

  #define MAIN_MENU_ITEM_23_DESC "View EEPROM Values"
  #define MAIN_MENU_ITEM_23_GCODE "M503 ; Display EEPROM settings"
  #define MAIN_MENU_ITEM_23_CONFIRM


#define MAIN_MENU_ITEM_24_DESC "Get System Info"
  #define MAIN_MENU_ITEM_24_GCODE "M1298 ; Get info"
#define MAIN_MENU_ITEM_24_CONFIRM

  #define MAIN_MENU_ITEM_25_DESC "Check Communication"
  #define MAIN_MENU_ITEM_25_GCODE "M105 ; Check communication"
  #define MAIN_MENU_ITEM_25_CONFIRM

  #define MAIN_MENU_ITEM_26_DESC "Show Real-Time Commands"
  #define MAIN_MENU_ITEM_26_GCODE "M111 S18 ; Show real-time commands"
  #define MAIN_MENU_ITEM_26_CONFIRM

  #define MAIN_MENU_ITEM_27_DESC "Toggle Silent Mode"
  #define MAIN_MENU_ITEM_27_GCODE "M906 S1 ; Toggle silent mode"
  #define MAIN_MENU_ITEM_27_CONFIRM

  #define MAIN_MENU_ITEM_28_DESC "Print Debug Messages"
  #define MAIN_MENU_ITEM_28_GCODE "M111 S19 ; Print debug messages"
  #define MAIN_MENU_ITEM_28_CONFIRM

  #define MAIN_MENU_ITEM_29_DESC "Set Filament Change Layer"
#define MAIN_MENU_ITEM_29_GCODE "M600"
#define MAIN_MENU_ITEM_29_CONFIRM
